 ...
 * @author  adrian
 */
public class JCurrencyDialog extends javax.swing.JDialog {
    ...
    public JCurrencyDialog(Frame parent, boolean modal) {
        super(parent, modal);
        init();
    }
    
    /** Creates new form JNumberDialog */
    public JCurrencyDialog(Dialog parent, boolean modal) {
        super(parent, modal);
        init();
    }
    ...
    private void init() {
        ...
        m_jcurrency.addEditorKeys(m_jKeys);
        m_jcurrency.reset();
        m_jcurrency.setDoubleValue(0.0);
        m_jcurrency.activate();
    ...
    public static Double showEditNumber(Component parent, String title, String message, Icon icon) {
        ...
        JCurrencyDialog myMsg;
        if (window instanceof Frame) { 
            myMsg = new JCurrencyDialog((Frame) window, true);
        } else {
            myMsg = new JCurrencyDialog((Dialog) window, true);
        }
    ...
    private void initComponents() {
        ...
        m_jcurrency = new com.openbravo.editor.JEditorCurrency();
        ...
        jPanel4.add(m_jcurrency, java.awt.BorderLayout.CENTER);
    ...
    private void jcmdOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcmdOKActionPerformed
        ...
        m_value = m_jcurrency.getDoubleValue();
        setVisible(false);
        dispose();
    ...
    private com.openbravo.editor.JEditorCurrency m_jcurrency;
