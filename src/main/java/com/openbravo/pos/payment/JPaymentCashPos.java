...
public class JPaymentCashPos extends javax.swing.JPanel implements JPaymentInterface {
    ...
    private void initComponents() {
        ...
        m_jChangeEuros.setBackground(Color.white);
        m_jChangeEuros.setHorizontalAlignment(SwingConstants.RIGHT);
        ...
        m_jChangeEuros.setPreferredSize(new Dimension(150, 25));
        ...
        m_jMoneyEuros.setBackground(new Color(153, 153, 255));
        m_jMoneyEuros.setHorizontalAlignment(SwingConstants.RIGHT);
        m_jMoneyEuros.setBorder(javax.swing.BorderFactory.createCompoundBorder(javax.swing.BorderFactory.createLineBorder(javax.swing.UIManager.getDefaults().getColor("Button.darkShadow")), javax.swing.BorderFactory.createEmptyBorder(1, 4, 1, 4)));
        m_jMoneyEuros.setOpaque(true);
        m_jMoneyEuros.setPreferredSize(new Dimension(150, 25));
        jPanel4.add(m_jMoneyEuros);
        m_jMoneyEuros.setBounds(120, 20, 150, 25);

        jPanel5.add(jPanel4, BorderLayout.NORTH);
        ...
        jPanel3.add(m_jTendered, BorderLayout.CENTER);
