...
public class PaymentPanelMagCard extends JPanel implements PaymentPanel {
    ...
    private void initComponents() {
        ...
        jPanel1 = new JPanel();
        jReset = new JButton();
        m_jKeyFactory = new JTextArea();
        jLabel6 = new JLabel();
        jLabel7 = new JLabel();
        m_jExpirationDate = new JLabel();
        m_jCardNumber = new JLabel();
        jLabel8 = new JLabel();
        m_jHolderName = new JLabel();
        ...
        m_jExpirationDate.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(UIManager.getDefaults().getColor("Button.darkShadow")), BorderFactory.createEmptyBorder(1, 4, 1, 4)));
        ...
        m_jCardNumber.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(UIManager.getDefaults().getColor("Button.darkShadow")), BorderFactory.createEmptyBorder(1, 4, 1, 4)));
        ...
        m_jHolderName.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createLineBorder(UIManager.getDefaults().getColor("Button.darkShadow")), BorderFactory.createEmptyBorder(1, 4, 1, 4)));
