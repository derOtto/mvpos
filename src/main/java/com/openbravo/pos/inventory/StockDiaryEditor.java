...
//    }
    ...
    private void initComponents() {
        ...
        m_jcodebar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        m_jreference.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        m_jEnter1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jEditProduct.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
