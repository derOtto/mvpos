...
//        m_TTP = new TicketParser(m_App.getDeviceTicket(), m_dlSystem);
    ...
    private void initComponents() {
        ...
        m_jbtnStockPreview.addActionListener(new ActionListener() {
        ...
        m_jEnter.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        m_jcodebar.setPreferredSize(new Dimension(135, 30));
        ...
        m_jKeyFactory.setPreferredSize(new Dimension(1, 1));
        ...
        btnDownloadProducts.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        m_jbtndate.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        m_jreason.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        m_jLocationDes.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        m_jDelete.setMaximumSize(new Dimension(54, 44));
        m_jDelete.setMinimumSize(new Dimension(54, 44));
        m_jDelete.setPreferredSize(new Dimension(54, 44));
        ...
        m_jUp.setMaximumSize(new Dimension(54, 44));
        m_jUp.setMinimumSize(new Dimension(54, 44));
        m_jUp.setPreferredSize(new Dimension(54, 44));
        m_jUp.setRequestFocusEnabled(false);
        m_jUp.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        m_jDown.setMaximumSize(new Dimension(54, 44));
        m_jDown.setMinimumSize(new Dimension(54, 44));
        m_jDown.setPreferredSize(new Dimension(54, 44));
        m_jDown.setRequestFocusEnabled(false);
        m_jDown.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        m_jEditLine.setMaximumSize(new Dimension(54, 44));
        m_jEditLine.setMinimumSize(new Dimension(54, 44));
        m_jEditLine.setPreferredSize(new Dimension(54, 44));
        m_jEditLine.setRequestFocusEnabled(false);
        m_jEditLine.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jEditAttributes.setMaximumSize(new Dimension(54, 44));
        jEditAttributes.setMinimumSize(new Dimension(54, 44));
        jEditAttributes.setPreferredSize(new Dimension(54, 44));
        jEditAttributes.setRequestFocusEnabled(false);
        jEditAttributes.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        add(catcontainer, BorderLayout.SOUTH);
    }// </editor-fold>//GEN-END:initComponents

    private void btnDownloadProductsActionPerformed(ActionEvent evt) {//GEN-FIRST:event_btnDownloadProductsActionPerformed
    ...
    private void m_jreasonActionPerformed(ActionEvent evt) {//GEN-FIRST:event_m_jreasonActionPerformed
    ...
    private void m_jDownActionPerformed(ActionEvent evt) {//GEN-FIRST:event_m_jDownActionPerformed

        m_invlines.goDown();

    }//GEN-LAST:event_m_jDownActionPerformed

    private void m_jUpActionPerformed(ActionEvent evt) {//GEN-FIRST:event_m_jUpActionPerformed

        m_invlines.goUp();

    }//GEN-LAST:event_m_jUpActionPerformed

    private void m_jDeleteActionPerformed(ActionEvent evt) {//GEN-FIRST:event_m_jDeleteActionPerformed
    ...
    private void m_jLocationActionPerformed(ActionEvent evt) {//GEN-FIRST:event_m_jLocationActionPerformed
        try {
            int i = 0;
    ...
    private void m_jLocationDesActionPerformed(ActionEvent evt) {//GEN-FIRST:event_m_jLocationDesActionPerformed
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                m_jKeyFactory.requestFocus();
    ...
    private void m_jbtnStockPreviewActionPerformed(ActionEvent evt) {//GEN-FIRST:event_m_jbtnStockPreviewActionPerformed
    ...
    private void m_jEditLineActionPerformed(ActionEvent evt) {//GEN-FIRST:event_m_jEditLineActionPerformed
