...
public class AuxiliarFilter extends javax.swing.JPanel implements ReportEditorCreator {
    ...
    private void initComponents() {
        ...
        m_jReference1.addActionListener(new ActionListener() {
        ...
        m_jBarcode1.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
    ...
    private void m_jReference1ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_m_jReference1ActionPerformed
    ...
    private void Enter2ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_Enter2ActionPerformed
        this.assignProductByCode();
    }//GEN-LAST:event_Enter2ActionPerformed

    private void Enter1ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_Enter1ActionPerformed
        this.assignProductByReference();
    }//GEN-LAST:event_Enter1ActionPerformed

    private void m_jBarcode1ActionPerformed(ActionEvent evt) {//GEN-FIRST:event_m_jBarcode1ActionPerformed
        this.assignProductByCode();
