...
public class JTicketsFinder extends javax.swing.JDialog implements EditorCreator {
    ...
    private void initComponents() {
        ...
        jPanel7.setPreferredSize(new Dimension(0, 210));
        ...
        jTxtStartDate.setPreferredSize(new Dimension(200, 25));

        jTxtEndDate.setPreferredSize(new Dimension(200, 25));

        btnDateStart.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/date.png"))); // NOI18N
        btnDateStart.setPreferredSize(new Dimension(50, 25));
        ...
        btnDateEnd.setPreferredSize(new Dimension(50, 25));
        ...
        jtxtCustomer.setPreferredSize(new Dimension(200, 25));
        ...
        btnCustomer.setPreferredSize(new Dimension(50, 25));
