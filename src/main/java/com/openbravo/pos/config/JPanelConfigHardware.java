...
public class JPanelConfigHardware extends javax.swing.JPanel implements PanelConfig {
    ...
    private void initComponents() {
        ...
        m_jDisplayParams.setLayout(new CardLayout());
        ...
        m_jPrinterParams1.setLayout(new CardLayout());
        ...
        m_jPrinterParams2.setLayout(new CardLayout());
        ...
        m_jPrinterParams3.setLayout(new CardLayout());
        ...
        m_jFiscalPrinterParams.setLayout(new CardLayout());
        ...
        m_jLabelPrinterParams.setLayout(new CardLayout());
        ...
        m_jScaleParams.setLayout(new CardLayout());
        ...
        m_jPLUParams.setLayout(new CardLayout());
