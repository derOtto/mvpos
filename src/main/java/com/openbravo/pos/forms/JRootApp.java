...
public class JRootApp extends JPanel implements AppView {
    ...
    private void initComponents() {
        ...
        m_jLblTitle = new JLabel();
        m_jLblPoweredBy = new JLabel();
        m_jLblSupportBy = new JLabel();
        m_jPanelContainer = new JPanel();
        m_jPanelLogin = new JPanel();
        jPanel4 = new JPanel();
        m_jLblDescriptionFirst = new JLabel();
        m_jLblDescriptionSecond = new JLabel();
        jPanel5 = new JPanel();
        m_jLogonName = new JPanel();
        ...
        m_jPanelTitle.setBorder(BorderFactory.createMatteBorder(0, 0, 1, 0, UIManager.getDefaults().getColor("Button.darkShadow")));
        m_jPanelTitle.setLayout(new java.awt.BorderLayout());

        m_jLblTitle.setHorizontalAlignment(SwingConstants.CENTER);
        m_jLblTitle.setText("Window.Title");
        m_jPanelTitle.add(m_jLblTitle, java.awt.BorderLayout.CENTER);

        m_jLblPoweredBy.setBorder(BorderFactory.createEmptyBorder(0, 5, 0, 5));
        m_jLblPoweredBy.setMaximumSize(new Dimension(142, 34));
        m_jLblPoweredBy.setMinimumSize(new Dimension(142, 34));
        m_jLblPoweredBy.setPreferredSize(new Dimension(142, 34));
        m_jPanelTitle.add(m_jLblPoweredBy, java.awt.BorderLayout.LINE_END);

        m_jLblSupportBy.setBorder(BorderFactory.createEmptyBorder(0, 5, 0, 5));
        m_jLblSupportBy.setMaximumSize(new Dimension(142, 34));
        m_jLblSupportBy.setMinimumSize(new Dimension(142, 34));
        m_jLblSupportBy.setPreferredSize(new Dimension(142, 34));
        ...
        m_jLblDescriptionFirst.setHorizontalAlignment(SwingConstants.CENTER);
        m_jLblDescriptionFirst.setText("Window.Description");
        m_jLblDescriptionFirst.setAlignmentX(0.5F);
        m_jLblDescriptionFirst.setHorizontalTextPosition(SwingConstants.CENTER);
        m_jLblDescriptionFirst.setMaximumSize(new Dimension(976, 800));
        m_jLblDescriptionFirst.setVerticalTextPosition(SwingConstants.BOTTOM);
        jPanel4.add(m_jLblDescriptionFirst);

        m_jLblDescriptionSecond.setHorizontalAlignment(SwingConstants.CENTER);
        m_jLblDescriptionSecond.setText("Window.Description");
        m_jLblDescriptionSecond.setVerticalAlignment(SwingConstants.TOP);
        m_jLblDescriptionSecond.setAlignmentX(0.5F);
        m_jLblDescriptionSecond.setHorizontalTextPosition(SwingConstants.CENTER);
        m_jLblDescriptionSecond.setMaximumSize(new Dimension(976, 800));
        m_jLblDescriptionSecond.setVerticalTextPosition(SwingConstants.BOTTOM);
        jPanel4.add(m_jLblDescriptionSecond);

        m_jPanelLogin.add(jPanel4, java.awt.BorderLayout.CENTER);

        m_jLogonName.setBorder(BorderFactory.createEmptyBorder(5, 5, 5, 5));
        m_jLogonName.setLayout(new java.awt.BorderLayout());

        jScrollPane1.setHorizontalScrollBarPolicy(ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        jScrollPane1.setVerticalScrollBarPolicy(ScrollPaneConstants.VERTICAL_SCROLLBAR_ALWAYS);
        jScrollPane1.setPreferredSize(new Dimension(510, 118));
        ...
        m_jClose.setIcon(new ImageIcon(getClass().getResource("/com/openbravo/images/exit.png"))); // NOI18N
        ...
        m_jPanelDown.setBorder(BorderFactory.createMatteBorder(1, 0, 0, 0, UIManager.getDefaults().getColor("Button.darkShadow")));
        m_jPanelDown.setLayout(new java.awt.BorderLayout());

        m_jHost.setIcon(new ImageIcon(getClass().getResource("/com/openbravo/images/display.png"))); // NOI18N
