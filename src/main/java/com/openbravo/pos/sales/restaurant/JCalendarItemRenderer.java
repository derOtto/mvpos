...
//        m_jDescription.setFont(new Font("SansSerif", Font.ITALIC, 11)); // TEXTO EXPLICATIVO
    ...
    */
    ...
    private void initComponents() {
        ...
        m_jDescription = new JLabel();
        jPanel1 = new JPanel();
        m_jTime = new JLabel();
        m_jTitle = new JLabel();
        m_jChairs = new JLabel();
        ...
        m_jDescription.setVerticalAlignment(SwingConstants.TOP);
        m_jDescription.setBorder(BorderFactory.createEmptyBorder(5, 20, 5, 20));
        ...
        m_jTime.setForeground(new Color(0, 0, 255));
        ...
        m_jTitle.setBorder(BorderFactory.createEmptyBorder(0, 5, 0, 0));
