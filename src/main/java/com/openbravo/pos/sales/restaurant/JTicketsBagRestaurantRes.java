...
public class JTicketsBagRestaurantRes extends javax.swing.JPanel implements EditorRecord {
    ...
    private void initComponents() {
        ...
        jPanelTime.setLayout(new BorderLayout());
        ...
        m_jToolbarContainer.setLayout(new BorderLayout());
        ...
        m_jToolbarContainer.add(jPanel4, BorderLayout.LINE_START);
        m_jToolbarContainer.add(m_jToolbar, BorderLayout.CENTER);

        jPanel2.add(m_jToolbarContainer, BorderLayout.NORTH);

        m_jPanelList.setBorder(javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5));
        m_jPanelList.setLayout(new BorderLayout());
        jPanel2.add(m_jPanelList, BorderLayout.LINE_START);

        jPanel1.setLayout(null);

        m_jPanelTime.setLayout(new BorderLayout());
        ...
        jPanel5.add(m_jKeys, BorderLayout.NORTH);

        jPanel2.add(jPanel5, BorderLayout.LINE_END);
