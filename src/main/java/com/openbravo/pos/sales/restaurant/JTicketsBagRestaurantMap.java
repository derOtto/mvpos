...
//    private static final Icon ICO_FRE = new NullIcon(22, 22);
    ...
    private void initComponents() {
        ...
        m_jPanelMap = new JPanel();
        jPanel1 = new JPanel();
        jPanel2 = new JPanel();
        m_jbtnReservations = new JButton();
        m_jbtnRefresh = new JButton();
        m_jText = new JLabel();

        setLayout(new CardLayout());

        m_jPanelMap.setLayout(new BorderLayout());

        jPanel1.setLayout(new BorderLayout());

        jPanel2.setLayout(new FlowLayout(FlowLayout.LEFT));

        m_jbtnReservations.setIcon(new ImageIcon(getClass().getResource("/com/openbravo/images/date.png"))); // NOI18N
        ...
        m_jbtnReservations.setMargin(new Insets(8, 14, 8, 14));
        m_jbtnReservations.setRequestFocusEnabled(false);
        m_jbtnReservations.addActionListener(new ActionListener() {
        ...
        m_jbtnRefresh.setIcon(new ImageIcon(getClass().getResource("/com/openbravo/images/reload.png"))); // NOI18N
        ...
        m_jbtnRefresh.setMargin(new Insets(8, 14, 8, 14));
        m_jbtnRefresh.setRequestFocusEnabled(false);
        m_jbtnRefresh.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
        ...
        jPanel1.add(jPanel2, BorderLayout.LINE_START);

        m_jPanelMap.add(jPanel1, BorderLayout.NORTH);

        add(m_jPanelMap, "map");
    }// </editor-fold>//GEN-END:initComponents

    private void m_jbtnRefreshActionPerformed(ActionEvent evt) {//GEN-FIRST:event_m_jbtnRefreshActionPerformed
    ...
    private void m_jbtnReservationsActionPerformed(ActionEvent evt) {//GEN-FIRST:event_m_jbtnReservationsActionPerformed
