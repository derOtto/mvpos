...
public abstract class JPanelTicket extends JPanel implements JPanelView, BeanFactoryApp, TicketsEditor {
    ...
    public void init(AppView app) throws BeanFactoryException {
        ...
        m_jPanelCentral.add(m_ticketlines, BorderLayout.CENTER);
...
//        String taxesid = panelconfig.getProperty("taxcategoryid");
    ...
    private void addTicketLine(ProductInfoExt oProduct, double dMul, double dPrice) {
        ...
        addTicketLine(new TicketLineInfo(oProduct, dMul, dPrice, tax, (Properties) (oProduct.getProperties().clone())));
    }
    ...
    private void initComponents() {
        ...
        m_jDiscountRatePanel = new JPanel();
        ...
        m_jDiscountMoneyPanel = new JPanel();
        ...
        m_jPanelImageViewer = new JPanel();
        ...
        m_jPanContainer.setLayout(new BorderLayout());
        ...
        m_jOptions.add(m_jButtons, BorderLayout.LINE_START);

        m_jPanelScripts.setLayout(new BorderLayout());
        ...
        m_jPanelScripts.add(m_jButtonsExt, BorderLayout.LINE_END);

        m_jOptions.add(m_jPanelScripts, BorderLayout.LINE_END);

        m_jPanelBag.setLayout(new BorderLayout());
        m_jOptions.add(m_jPanelBag, BorderLayout.CENTER);

        m_jPanContainer.add(m_jOptions, BorderLayout.NORTH);

        m_jPanTicket.setBorder(javax.swing.BorderFactory.createEmptyBorder(3, 5, 5, 0));
        m_jPanTicket.setLayout(new BorderLayout());

        m_jPanelCentral.setLayout(new BorderLayout());
        ...
        m_jPanelCentral.add(jPanel4, BorderLayout.SOUTH);

        m_jPanTicket.add(m_jPanelCentral, BorderLayout.CENTER);
        ...
        m_jPanTicket.add(jPanel5, BorderLayout.LINE_END);

        m_jPanContainer.add(m_jPanTicket, BorderLayout.CENTER);
        ...
        m_jContEntries.setLayout(new BorderLayout());
        ...
        m_jContEntries.add(m_jPanEntries, BorderLayout.NORTH);

        m_jPanelImageViewer.setBorder(javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5));
        m_jPanelImageViewer.setLayout(new BorderLayout());
        m_jPanelImageViewer.add(m_jImage, BorderLayout.CENTER);

        m_jContEntries.add(m_jPanelImageViewer, BorderLayout.CENTER);

        m_jPanContainer.add(m_jContEntries, BorderLayout.LINE_END);

        catcontainer.setBorder(javax.swing.BorderFactory.createEmptyBorder(5, 5, 5, 5));
        catcontainer.setLayout(new BorderLayout());
        m_jPanContainer.add(catcontainer, BorderLayout.SOUTH);
