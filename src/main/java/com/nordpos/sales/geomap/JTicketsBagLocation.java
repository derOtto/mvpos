...
public class JTicketsBagLocation extends JPanel {
    ...
    private void initComponents() {
        ...
        m_jMovTicket = new JButton();
        m_jLocationMap = new JButton();
        ...
        m_jMovTicket.setIcon(new ImageIcon(getClass().getResource("/com/openbravo/images/redo16.png"))); // NOI18N
        ...
        m_jLocationMap.setIcon(new ImageIcon(getClass().getResource("/com/openbravo/images/applications-internet.png"))); // NOI18N
